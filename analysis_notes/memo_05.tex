...
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_dayavg_mp1_davg_casec.png}
...
\centering
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_dayavg_mp1_agg_davg_caseb.png}
  \caption{Case b --- \texttt{mp1\_agg} (aggregated)}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_dayavg_mp1_agg_davg_casec.png}
  \caption{Case c --- \texttt{mp1\_agg} (aggregated)}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_dayavg_mp1_dis_davg_casec.png}
...
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_dayavg_bot_mass_casec.png}
  \caption{Case c}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_max_mp1_davg_casea.png}
  \caption{Case a}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_max_mp1_davg_caseb.png}
  \caption{Case b}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/planview_max_mp1_davg_casec.png}
  \caption{Case c}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/diff_mp1_davg_caseb_minus_casea.png}
  \caption{Case b $-$ case a}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/diff_mp1_davg_casec_minus_casea.png}
  \caption{Case c $-$ case a}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{../FVCOM_MP_test_run/PYTHON/output/spatial_distribution/diff_mp1_davg_casec_minus_caseb.png}
