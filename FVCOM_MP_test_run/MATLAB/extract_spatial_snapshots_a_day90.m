% EXTRACT_SPATIAL_SNAPSHOTS_A_DAY90
% Extract spatial snapshot and station time-series fields from the case-a
% FVCOM-MP NetCDF output centred on simulation day 90 (Memo 05).
%
...
%   <test_root>/OUTPUT_a/backup_data/waterPACT_a_0009.nc
%
% Default MAT output:
%   <test_root>/OUTPUT_a/spatial_snapshots_a_day90.mat  (v7.3 / HDF5)
%
% HPC usage (run from any directory on Kestrel data-analysis node):
%   cd /scratch/yhuang168/waterPACT_MP_floc
%   matlab -nodisplay -batch "run('MATLAB/extract_spatial_snapshots_a_day90.m')"
%
...
nc_file       = '/kfs3/scratch/yhuang168/waterPACT_MP_floc/OUTPUT_a/backup_data/waterPACT_a_0009.nc';
out_mat       = '/kfs3/scratch/yhuang168/waterPACT_MP_floc/OUTPUT_a/spatial_snapshots_a_day90.mat';
target_day    = 90;
last_n_hours  = 24;
...
if isempty(out_mat)
    out_mat = fullfile(output_dir, ['spatial_snapshots_' case_id '_day90.mat']);
end
