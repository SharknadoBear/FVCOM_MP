% EXTRACT_SPATIAL_SNAPSHOTS_B_C_DAY30
% Extract spatial snapshot and station time-series fields from the case-b
% and case-c FVCOM-MP NetCDF outputs centred on simulation day 30 (Memo 05).
%
...
%   <test_root>/OUTPUT_b/backup_data/waterPACT_b_0003.nc
%   <test_root>/OUTPUT_c/backup_data/waterPACT_c_0003.nc
%
% Default MAT outputs:
%   <test_root>/OUTPUT_b/spatial_snapshots_b_day30.mat  (v7.3 / HDF5)
%   <test_root>/OUTPUT_c/spatial_snapshots_c_day30.mat  (v7.3 / HDF5)
%
% HPC usage (run from any directory on Kestrel data-analysis node):
%   cd /scratch/yhuang168/waterPACT_MP_floc
%   matlab -nodisplay -batch "run('MATLAB/extract_spatial_snapshots_b_c_day30.m')"
%
...
nc_files     = { ...
    '/kfs3/scratch/yhuang168/waterPACT_MP_floc/OUTPUT_b/backup_data/waterPACT_b_0003.nc'; ...
    '/kfs3/scratch/yhuang168/waterPACT_MP_floc/OUTPUT_c/backup_data/waterPACT_c_0003.nc' };
target_day   = 30;
last_n_hours = 24;
...
%  Loop over cases
% --------------------------------------------------------------------------
fprintf('Starting day-30 spatial snapshot extraction for %d case(s).\n\n', numel(case_ids));
...
for icase = 1:numel(case_ids)
    ...
    out_mat = fullfile(case_output_dir, ['spatial_snapshots_' case_id '_day30.mat']);
