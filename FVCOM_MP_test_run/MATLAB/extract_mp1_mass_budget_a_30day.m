% EXTRACT_MP1_MASS_BUDGET_A_30DAY
% Integrate FVCOM-MP mp1 water and bed mass across three consecutive output
% files (_0001, _0002, _0003) to cover a ~30-day period.
%
...
%   matlab -batch "run('extract_mp1_mass_budget_a_30day.m')"
%
...
if isempty(out_mat)
    out_mat = fullfile(output_dir, ['mp1_mass_budget_' case_id '_30day.mat']);
end
